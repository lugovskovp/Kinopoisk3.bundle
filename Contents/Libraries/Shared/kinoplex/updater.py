...
class Updater(object):
    def __init__(self, core, channel, repo='lugovskovp'):
        Log("Updater start repo: %s" % repo)
        self._core = core
        ...
        self.stable_url = 'https://api.github.com/repos/%s/Kinopoisk3.bundle/releases/latest' % self._repo
        self.beta_url = 'https://api.github.com/repos/%s/Kinopoisk3.bundle/git/refs/heads/beta' % self._repo
        self.archive_url = 'https://github.com/%s/Kinopoisk3.bundle/archive/%s.zip'
        
        Log("_core: %s" % self._core)
    ...
    def auto_update_thread(cls, core, pref):
        ...
        core.runtime.create_timer(60, Updater.auto_update_thread, True, core.sandbox, True, core=core, pref=pref)
