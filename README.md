...
> После закачки автоматически стартует данный агент для новинок (см. [Настройки](#настройки))</br>
...
- скоринг по наименованию, рассчитывая [расстояние Левенштейна](https://ru.wikipedia.org/wiki/Расстояние_Левенштейна) (80%)
- скоринг по типу - учитывает фильм/сериал (5%)
- SCORING по году, отсутствие года - не так важно в весе, как разница с годом поиска. (15%)
