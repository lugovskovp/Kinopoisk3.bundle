...
### Plex agent.
Агент, используя информацию уже собранную сканнером, производит поиск в интернете и сопоставление найденной информации ранее уже созданному сканнером объекту. </br>
...
> В случае, если автосопоставление не сработало, (что изредка случается), сопоставляю вручную.
...
> [!IMPORTANT]  
> Примерно с января-февраля 2026 в новых версиях PMS Plex изменил принципы работы плагинов. И, хотя плагин был виден в настройках плагинов, возможность выбрать его в Управлять - Библиотеки исчезла.  
> Для решения этой проблемы с версии 1.16 у плагина изменено внутреннее наименование. 
> Кроме этого в общих настройках ("Настройка - Библиотека") необходимо **включить чекбокс** "Show legacy agents during library setup"
> 
> <img src="https://github.com/lugovskovp/Kinopoisk3.bundle/blob/master/pix/show_legacy_agents.png" alt="Show legacy agents during library setup">
...
- Поиск: для сериалов убирать из результатов F:фильм и V:видео
