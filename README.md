...
После закачки ВРУЧНУЮ запускаю данный агент для несопоставленных новинок (см. [Настройки](https://github.com/lugovskovp/Kinopoisk3.bundle/tree/beta#настройки))</br>
Похоже, PMS с какого-то времени убрал автозапуск для неродных плагинов.
